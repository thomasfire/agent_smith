...
def main():
    ...
    vk_process = Process(target=vk_run.run_vk_bot, args=(
    vk, chatid, albumid, userid, msgshistory, tl_msgs, list_of_alles, list_of_imnts, list_of_cmds, iterations_vk,
    curr_stat))
    tl_process = Process(target=telegrambot.tlmain,
    ...
    while True:
        ...
        if iterations_tl.value == 0:
            ...
            tl_process = Process(target=telegrambot.tlmain, args=(
            url, tl_msgs, msgshistory, list_of_alles, list_of_imnts, iterations_tl, curr_stat))
        ...
        if iterations_vk.value == 0:
            ...
            vk_process = Process(target=vk_run.run_vk_bot, args=(
            vk, chatid, albumid, userid, msgshistory, tl_msgs, list_of_alles, list_of_imnts, list_of_cmds,
